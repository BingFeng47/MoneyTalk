...
export default function DashboardInsights() {
  ...
  useEffect(() => {
    const initialPrompt = "Use available data to analyze my retirement plan and provide insights and suggestions in Markdown format.";
  ...
  return (
    <div id='DashboardInsights' className="retirement-insights">
      <Card>
