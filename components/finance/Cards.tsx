    ...
    <div className="container mx-auto p-4">
...

      {
        filteredCards.map((cardData)=>(
            <Card className={`w-96 h-56  text-white rounded-xl overflow-hidden shadow-lg ${cardData.bank.toLowerCase() === 'maybank' ? 'bg-gradient-to-br from-orange-400 via-yellow-500 to-yellow-300' : 'bg-gradient-to-br from-red-600 via-red-500 to-orange-400'}`}>
